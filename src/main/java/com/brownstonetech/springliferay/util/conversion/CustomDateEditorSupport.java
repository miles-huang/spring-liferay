 ...
 */
public abstract class CustomDateEditorSupport extends PropertyEditorSupport {
	 ...
	 */
	public CustomDateEditorSupport(boolean allowEmpty, DateFormat... dateFormat) {
	 ...
	 */
	public CustomDateEditorSupport(boolean allowEmpty, int exactDateLength, DateFormat... dateFormat) {
		if ( dateFormat.length < 1)
			throw new IllegalArgumentException("At least one dateFormat need be speficified.");
	...
	protected abstract void setDateValue(Date date);
	...
	public String getAsText() {
		...
		return (value != null ? this.dateFormat[0].format(value) : "");
	}
